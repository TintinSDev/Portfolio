    ...
    <div className="sticky top-0 z-10 navbar">
      <div className="flex justify-between items-center py-5 container mx-auto">
        <Link href={"/"} className={`${pacifico.className} text-2xl`}>
          <span className="text-primary">M</span>artin{" "}
          <span className="text-primary">M</span>aina
        </Link>
        <NavigationMenu>
                  ...
                  <SheetHeader>
                    <SheetDescription className="my-10">
                      <p className="leading-8">
                        Have a project you&apos;d like to discuss? I&apos;d love
                        to hear from you.
                      </p>
                      <Hire />
        ...
        <div className="lg:hidden flex">
          <Sheet>
            ...
            <SheetContent side="left" className="bg-secondary overflow-auto">
              <SheetHeader>
                <SheetDescription className="my-10">
                  <p className="leading-8">
                    Driven, innovative Software Engineer with more than 5 years
                    of experience in the development of software and solutions.
                    A conscientious person who pays attention to details.
                  </p>
                  <Separator className="my-10" />
                  <ul className="grid grid-cols-3 gap-5 font-semibold">
                    <li>
                      <Link
                        href="/"
                        className={`${
